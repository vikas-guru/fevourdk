...
const form = useForm({
    ...
    sort_order: props.program.sort_order,
})
    ...
    <AdminLayout>
        <div class="max-w-4xl">
            <form @submit.prevent="submit" class="space-y-6">
                <!-- Page Header -->
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-900">Edit Program: {{ program.title }}</h1>
                    <p class="mt-1 text-sm text-gray-600">Update the program information and settings</p>
                </div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div>
                        ...
                        <!-- Current Image -->
                        <div v-if="program.image" class="mt-4">
                            <p class="text-sm font-medium text-gray-700 mb-2">Current Image:</p>
                            <img :src="`/storage/${program.image}`" :alt="program.title" class="h-32 w-auto rounded-lg shadow-md">
                        </div>
                    </div>
                </div>
