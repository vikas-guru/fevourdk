        ...
        <div class="min-h-screen bg-gray-50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 mt-2">Manage your donations and track your impact</p>
                </div>
                ...
                <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="overflow-hidden">
                        <div v-if="donations.length === 0" class="px-6 py-8 text-center text-gray-500">
                            ...
                            <inertia-link href="/donate" class="mt-4 inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <inertia-link href="/donate" class="block bg-primary-600 rounded-lg p-6 text-center text-white hover:bg-primary-700 transition-colors">
                    ...
                    <inertia-link href="/campaigns" class="block bg-white border-2 border-gray-300 rounded-lg p-6 text-center text-gray-700 hover:border-primary-500 hover:text-primary-600 transition-colors">
                        <svg class="mx-auto h-12 w-12 mb-3" fill="currentColor" viewBox="0 0 20 20">
